  ...
  return (
    <div className="px-4 md:px-16 pt-28 pb-24 min-h-screen">
      <div className="max-w-4xl mx-auto text-gray-300 leading-relaxed">
        <h1 className="text-4xl font-bold mb-6 text-white">Terms of Service for kisskh</h1>
        <p className="mb-4"><strong>Last Updated:</strong> July 26, 2024</p>

        <p className="mb-6">
          Please read these Terms of Service ("Terms") carefully before using the kisskh website (the "Service") operated by us. Your access to and use of the Service is conditioned on your acceptance of and compliance with these Terms. These Terms apply to all visitors, users, and others who access or use the Service.
        </p>
        ...
        <p className="mb-4">
          kisskh is a user interface that acts as a discovery tool for movies and TV shows. The Service allows users to browse, search, and discover content information provided by a third-party movie and TV show database. All video content is streamed via embedded players from third-party, publicly available sources.
        </p>
        <p className="font-bold text-white mb-4">
          IMPORTANT: kisskh does not host, store, upload, or distribute any video content. We are an index and database of content found publicly on the internet. All video players are embedded from third-party streaming services that are not affiliated with us.
        </p>
        
        <h2 className="text-2xl font-bold mt-8 mb-4 text-white">2. Third-Party Content</h2>
        <p className="mb-4">
            The Service provides links to and embeds content from third-party websites and services that are not owned or controlled by kisskh. We have no control over, and assume no responsibility for, the content, privacy policies, or practices of any third-party websites or services.
        </p>
        <p className="mb-4">
            You further acknowledge and agree that kisskh shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods or services available on or through any such web sites or services. We are not responsible for the accuracy, legality, or copyright compliance of the content provided by these third parties.
        </p>

        <h2 className="text-2xl font-bold mt-8 mb-4 text-white">3. Intellectual Property</h2>
        <p className="mb-4">
            The Service and its original content (excluding content provided by users or third parties), features, and functionality are and will remain the exclusive property of kisskh and its licensors. All metadata and artwork for movies and TV shows are provided by our third-party data source and are the property of their respective owners.
        </p>
        ...
        <p className="mb-4">
            In no event shall kisskh, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.
        </p>
        ...
        <p className="mb-4">If you have any questions about these Terms, please contact us at: <a href="mailto:admin@kisskh.cam" className="text-[var(--brand-color)] hover:underline">admin@kisskh.cam</a></p>
      </div>
    </div>
  );
};
