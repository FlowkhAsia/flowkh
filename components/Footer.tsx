...
const FooterLink: React.FC<{
  ...
  return (
    <a href={path} onClick={handleClick} className="text-pink-200/60 hover:text-white text-sm transition-colors">{children}</a>
  );
};
...
const Footer: React.FC<FooterProps> = ({ navigate }) => {
  return (
    <footer className="container mx-auto px-4 sm:px-6 lg:px-16 pt-8 pb-12">
      <div className="border-t border-[#501332] mb-8" />
