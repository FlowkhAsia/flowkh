    ...
    <div className="space-y-2 md:space-y-3">
      ...
      <div className="group/row relative md:-ml-2 overflow-hidden">
        <button
            ...
            className="absolute top-0 bottom-0 left-2 z-40 m-auto h-9 w-9 cursor-pointer opacity-0 transition [@media(hover:hover)]:lg:hover:scale-125 [@media(hover:hover)]:group-hover/row:opacity-100 bg-black/50 rounded-full text-white shadow-md hover:bg-black/80"
        >
        ...
        <button
            ...
            className="absolute top-0 bottom-0 right-2 z-40 m-auto h-9 w-9 cursor-pointer opacity-0 transition [@media(hover:hover)]:lg:hover:scale-125 [@media(hover:hover)]:group-hover/row:opacity-100 bg-black/50 rounded-full text-white shadow-md hover:bg-black/80"
        >
