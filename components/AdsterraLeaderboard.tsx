...
const AdsterraLeaderboard: React.FC = () => {
  ...
  return (
    ...
    <div ref={wrapperRef} className="my-8 md:my-12 w-full max-w-[728px] mx-auto flex justify-center items-center transition-all duration-200" aria-label="Advertisement">
