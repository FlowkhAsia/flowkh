  ...
  return (
    <div className="px-4 md:px-16 pt-28 pb-24 min-h-screen">
      <div className="max-w-4xl mx-auto text-[#5e1b35] leading-relaxed">
        <h1 className="text-4xl font-bold mb-6 text-[#4a0424]">Privacy Policy for flowkh</h1>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#4a0424]">1. INFORMATION WE COLLECT</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#4a0424]">2. HOW WE USE YOUR INFORMATION</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#4a0424]">3. THIRD-PARTY SERVICES</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#4a0424]">4. DATA SECURITY</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#4a0424]">5. CHILDREN'S PRIVACY</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#4a0424]">6. CHANGES TO THIS PRIVACY POLICY</h2>
        <p className="mb-4">
            We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page. You are advised to review this Privacy Policy periodically for any changes.
        </p>

        <h2 className="text-2xl font-bold mt-8 mb-4 text-[#4a0424]">7. CONTACT US</h2>
