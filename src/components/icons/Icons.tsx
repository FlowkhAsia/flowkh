...
export const FlowkhLogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130 40" preserveAspectRatio="xMidYMid meet" focusable="false">
        <text x="0" y="30" className="font-bebas" fill="white" fontSize="36">FLOW</text>
        <g transform="translate(75, 0)">
            <rect x="0" y="1" width="55" height="38" rx="6" className="fill-[var(--brand-color)]" />
            <text x="27.5" y="30" className="font-bebas" fill="#202020" fontSize="36" textAnchor="middle">KH</text>
        </g>
    </svg>
);
...
export const BookmarkSolidIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path fillRule="evenodd" d="M6.32 2.577a49.255 49.255 0 0111.36 0c1.497.174 2.57 1.46 2.57 2.93V21L12 17.25 4.5 21V5.507c0-1.47 1.073-2.756 2.57-2.93z" clipRule="evenodd" />
    </svg>
);
