  ...
  return (
    <div className="px-4 md:px-16 pt-28 pb-24 min-h-screen">
      <div className="max-w-4xl mx-auto text-gray-300 leading-relaxed">
        <h1 className="text-4xl font-bold mb-6 text-white">Terms of Service for flowkh</h1>
        ...
        <p className="mb-4">
          flowkh is a user interface that acts as a discovery tool for movies and TV shows. The Service allows users to browse, search, and discover content information provided by The Movie Database (TMDB). All video content is streamed via embedded players from third-party, publicly available sources.
        </p>
